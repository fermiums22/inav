...
static void vtxProtoUpdatePowerMetadata(void);
...
const uint16_t trampPowerTable_5G8[VTX_TRAMP_5G8_MAX_POWER_COUNT]         = { 25, 100, 400, 800, 1600 };
const char * const trampPowerNames_5G8[VTX_TRAMP_5G8_MAX_POWER_COUNT + 1] = { "---", "25 ", "100", "400", "800", "1K6" };

static void vtxProtoUpdatePowerMetadata(void)
{
    vtxState.metadata.powerTablePtr  = trampPowerTable_5G8;
    vtxState.metadata.powerTableCount = VTX_TRAMP_5G8_MAX_POWER_COUNT;
    
    impl_vtxDevice.capability.powerNames = (char **)trampPowerNames_5G8;
